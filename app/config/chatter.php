...
return [
    ...
    */
    ...
    'description'   => 'Forums for general topics and your relams council.',
    ...
    */
    ...
    'user' => [
        'namespace'                     => 'OpenDominion\Models\User',
        'database_field_with_user_name' => 'display_name',
    ...
    */
    ...
    'middleware' => [
        'global'     => ['web', \OpenDominion\Http\Middleware\RealmForumSelect::class],
        'home'       => [],
        'discussion' => [
            'index'   => [],
            'show'    => [],
