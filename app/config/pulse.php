...
use OpenDominion\Pulse\Recorders\QueryCountPerRoute;
...
return [
    ...
    */
    ...
    'recorders' => [
        ...
        QueryCountPerRoute::class => [
            'enabled' => env('PULSE_QUERY_COUNT_PER_ROUTE_ENABLED', true),
            'sample_rate' => env('PULSE_QUERY_COUNT_PER_ROUTE_SAMPLE_RATE', 1),
            'ignore' => [
                '#^/'.env('PULSE_PATH', 'pulse').'#', // Pulse dashboard...
                '#^/telescope#', // Telescope dashboard...
                '#^/_debugbar#', // Debugbar (local)...
                '#^/_ignition#', // Ignition (local)...
                '#^/_boost#', // Laravel Boost MCP (local)...
