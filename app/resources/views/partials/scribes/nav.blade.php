            ...
            <div class="col-md-12 col-md-12">
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="{{ Route::is('scribes.races') ? 'active' : null }}"><a href="{{ route('scribes.races') }}">Operations</a></li>
                        <li class="{{ Route::is('scribes.races') ? 'active' : null }}"><a href="{{ route('scribes.races') }}">Spells</a></li>
                    </ul>
                </div>
            </div>
        </div>
