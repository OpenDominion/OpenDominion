...
@section('content')
    <div class="card">
        <div class="card-header">
            <span class="card-title">Create New Objective for: {{ $raid->name }}</span>
        </div>
        <form action="{{ route('staff.administrator.raids.objectives.create', $raid) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            @if ($errors->has('order'))
                                <span class="form-text text-red">{{ $errors->first('order') }}</span>
                            @endif
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            @if ($errors->has('score_required'))
                                <span class="form-text text-red">{{ $errors->first('score_required') }}</span>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('staff.administrator.raids.show', $raid) }}" class="btn btn-secondary">
