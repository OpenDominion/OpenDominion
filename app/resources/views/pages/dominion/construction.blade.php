            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @if ($selectedDominion->discounted_land)
                        <p>Additionally, {{ $selectedDominion->discounted_land }} acres from invasion can be built at reduced cost of {{ number_format(ceil($constructionCalculator->getPlatinumCost($selectedDominion) * $constructionCalculator->getDiscountedLandMultiplier($selectedDominion))) }} platinum and {{ number_format(ceil($constructionCalculator->getLumberCost($selectedDominion) * $constructionCalculator->getDiscountedLandMultiplier($selectedDominion))) }} lumber.</p>
                    @endif
