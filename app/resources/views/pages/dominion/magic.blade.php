                        ...
                        @foreach ($spellCalculator->getActiveSpells($selectedDominion) as $activeSpell)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($activeSpell->cast_by_dominion_id == $selectedDominion->id || $selectedDominion->realm->dominions->pluck('id')->contains($activeSpell->cast_by_dominion_id) || $target->getSpellPerkValue('surreal_perception'))
