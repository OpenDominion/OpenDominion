            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @if ($yourRealmData)
                        ...
                        @if ($totalScore > 0)
                            <p><strong>Realm Share:</strong> {{ min(number_format($raidCalculator::MAX_REALM_REWARD_RATIO * 100), number_format($entry['total_score'] / $totalScore * 100)) }}% of total spoils</p>
                        @endif
                    @else
