...
<div class="action-form-container" id="{{ $formId }}">
    <div class="mb-2">
        Action:
        <select class="form-select form-select-sm" name="action" {{ $isLocked ? 'disabled' : null }}>
    ...
    <div class="mb-2 action-options train" style="{{ $selectedAction != 'train' ? 'display: none;' : '' }}">
        Unit:
        <select class="form-select form-select-sm" name="key" {{ ($selectedAction != 'train' || $isLocked) ? 'disabled' : null }}>
            <option></option>
    ...
    <div class="mb-2 action-options construct" style="{{ $selectedAction != 'construct' ? 'display: none;' : '' }}">
        Building:
        <select class="form-select form-select-sm" name="key" {{ ($selectedAction != 'construct' || $isLocked) ? 'disabled' : null }}>
            <option></option>
    ...
    <div class="mb-2 action-options explore rezone" style="{{ !in_array($selectedAction, ['explore', 'rezone']) ? 'display: none;' : '' }}">
        Land Type:
        <select class="form-select form-select-sm" name="key" {{ (!in_array($selectedAction, ['explore', 'rezone']) || $isLocked) ? 'disabled' : null }}>
            <option></option>
    ...
    <div class="mb-2 action-options rezone" style="{{ $selectedAction != 'rezone' ? 'display: none;' : '' }}">
        Target Land Type:
        <select class="form-select form-select-sm" name="key2" {{ ($selectedAction != 'rezone' || $isLocked) ? 'disabled' : null }}>
            <option></option>
            @foreach ($landTypes as $landType)
    ...
    <div class="mb-2 action-options spell" style="{{ $selectedAction != 'spell' ? 'display: none;' : '' }}">
        Spell:
        <select class="form-select form-select-sm" name="key" {{ ($selectedAction != 'spell' || $isLocked) ? 'disabled' : null }}>
            <option></option>
    ...
    <div class="mb-2 action-options daily_bonus" style="{{ $selectedAction != 'daily_bonus' ? 'display: none;' : '' }}">
        Bonus:
        <select class="form-select form-select-sm" name="key" {{ ($selectedAction != 'daily_bonus' || $isLocked) ? 'disabled' : null }}>
            <option></option>
