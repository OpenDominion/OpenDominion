        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>The base cost of each advancement is 3600 + 0.65x highest land achieved and increases by 150 after each unlock (min 3900). Most advancements require unlocking another before you can select them. Please consult the tech tree below.</p>
