        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>A hero gains 1 XP per acre gained from invasion, 2 XP per successful info operation (excluding bots), 4 XP per successful black operation, and 6 XP per successful war operation.</p>
