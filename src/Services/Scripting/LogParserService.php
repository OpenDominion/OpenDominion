...
class LogParserService
{
    ...
    public function parselogfile($data): array
    {
        ...
        foreach ($results[0] as $k => $string) {
            ...
            $types = ['release', 'daily', 'bank', 'destruction', 'rezone', 'construction', 'explore', 'magic', 'train'];
    ...
    public function parse_explore($string) {
    ...
    public function parse_construction($string) {
    ...
    public function parse_destruction($string) {
    ...
    public function parse_rezone($string) {
    ...
    public function parse_bank($string) {
    ...
    public function parse_magic($string) {
    ...
    public function parse_daily($string) {
        $dailies = [];
    ...
    public function parse_train($string) {
    ...
    public function parse_release($string) {
