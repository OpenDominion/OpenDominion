...
class TickService
{
        ...
        DB::transaction(function () use ($where) {
            ...
            DB::table('dominions')
                ...
                ->update([
                    ...
                    'dominions.spy_strength' => DB::raw('dominions.spy_strength + dominion_tick.spy_strength * 100'),
                    'dominions.wizard_strength' => DB::raw('dominions.wizard_strength + dominion_tick.wizard_strength * 100'),
                    ...
                    'dominions.resource_boats' => DB::raw('dominions.resource_boats + dominion_tick.resource_boats * 100'),
    ...
    public function tickDaily()
    {
        ...
        foreach (Round::with('dominions')->starting()->get() as $round) {
