...
//            'bankingCalculator' => app(BankingCalculator::class),
    ...
    public static function printMethodValues($class, array $methods) {
        ...
        foreach ($methods as $method) {
            ...
            } elseif (in_array($reflectionMethod->getName(), ['getOffensivePower', 'getOffensivePowerRaw', 'getOffensivePowerMultiplier', 'getDefensivePower', 'getDefensivePowerRaw', 'getDefensivePowerMultiplier', 'getSpyRatio', 'getSpyRatioRaw', 'getWizardRatio', 'getWizardRatioRaw'])) {
