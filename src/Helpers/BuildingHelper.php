...
class BuildingHelper
{
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'school' => 'Produces 1 research point, 2 gems, 3 mana, 4 lumber, 5 platinum, and 6 ore per hour.',
            'oldschool' => 'Produces (1 - (Schools / Total Land)) research points per hour (minimum of 0.5). Limited to 50% of your total land.',
