...
//                break;
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'wizard_guild' => 'Increases Wizard Strength refresh rate, increases wizard power (except Dark Elf), reduces Wizard and Archmage training cost, reduces spell costs, and reduces losses on failed black op spells.<br><br>Wizard Strength refresh rate increased by 0.1% per 1% owned, up to a maximum of 2% at 20% owned.<br>Wizard power increased by 2% per 1% owned, up to a maximum of 20% at 10% owned.<br>Wizard and Archmage training costs reduced by 4% per 1% owned, up to a maximum of 40% at 10% owned.<br/>Spell cost and losses on failed black ops reduced by 3% per 1% owned, up to a maximum of 30% at 10% owned.',
            ...
            'forest_haven' => 'Increases Spy Strength refresh rate, increases spy power, reduces Spy training cost, reduces losses on failed spy ops, and reduces incoming damage from Fireball/Disband Spies.<br><br>Spy Strength refresh rate increased by 0.1% per 1% owned, up to a maximum of 2% at 20% owned.<br>Spy power increased by 2% per 1% owned, up to a maximum of 20% at 10% owned.<br>Spy training costs reduced by 4% per 1% owned, up to a maximum of 40% at 10% owned.<br/>Disband spies damage and losses on failed spy ops reduced by 3% per 1% owned, up to a maximum of 30% at 10% owned.<br>Fireball damage reduced by 10% per 1% owned, up to a maximum of 80% at 8% owned.',
