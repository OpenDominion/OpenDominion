...
//                break;
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'school' => 'Produces 25 research points each hour per 1% owned, up to a maximum of 750 at 30% owned (limit 1 per acre).<br><br>Generates an additional 125 research points per 1% owned when invading targets at least 75% of your size, up to a maximum of 2500 at 20% owned (limit 5 per acre).',
