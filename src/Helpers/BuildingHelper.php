...
//                break;
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'forest_haven' => 'Increases Spy Strength refresh reate, reduces Spy training cost, reduces losses on failed spy ops, and reduces incoming Fireball damage.<br><br>Spy Strength refresh rate increased by 0.1% per 1% owned, up to a maximum of 2% at 20% owned.<br>Spy training costs reduced by 2% per 1% owned, up to a maximum of 40% at 20% owned.<br/>Failed spy ops losses reduced by 3% per 1% owned, up to a maximum of 30% at 10% owned.<br>Fireball damage and platinum theft reduced by 10% per 1% owned, up to a maximum of 80% at 8% owned.',
