...
class BuildingHelper
{
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'masonry' => 'Increases castle bonuses by 2.75% per 1% owned.<br><br>Reduces the maximum amount of damage that can be dealt to your castle by Lightning Bolt by 5% per 1% owned, up to a maximum of 50% at 10% owned.',
