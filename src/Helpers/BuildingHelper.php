...
class BuildingHelper
{
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'dock' => 'Produces 1 boat every 20 hours on average.<br>Each dock prevents 2 of your boats from being sunk (increases by 0.05 each day of the round).<br>Produces 40 bushels of food per hour.',
        ];
