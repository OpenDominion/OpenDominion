...
class BuildingHelper
{
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'wizard_guild' => 'Produces 5 mana per hour.<br><br>Each Wizard Guild increases the number of peasants protected from Fireball to 24 (from 6) for up to 5 wizards (max 120 per Guild).<br><br>Reduces damage from Lightning Bolt by 10% per 1% owned, up to a maximum of 50% at 5% owned.',
