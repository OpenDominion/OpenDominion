...
class MiscHelper
{
    ...
    public function getGeneralHelpString(string $type) {
        $helpStrings = [
            ...
            'wizard_resilience' => 'Gained by victims of the fireball and lighting bolt spells.<br>Increases peasant growth by 1% of your population deficit per 125 resilience.<br>Repairs 1% of lightning damage per 40 resilience after 12 hours.',
