...
class SpellHelper
{
    ...
    public function getSpellPerkStrings()
    {
        return [
            ...
            'disable_unit_summoning' => 'Halts all racial unit summoning',
            ...
            'tech_production_raw_per_acre' => 'Generates %+g research points per acre of land',
            ...
            'theft_chance' => '%+g%% chance of success for theft',
            'theft_gains' => '%+g%% resources gained from theft',
            'theft_strength_cost' => '%+g spy strength cost of theft',
