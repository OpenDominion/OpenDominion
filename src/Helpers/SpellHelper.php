...
class SpellHelper
{
    ...
    public function getSpellPerkStrings()
    {
        return [
            ...
            'conversions_range' => 'Conversions increased by %d%% against dominions under 75%% of your size',
            ...
            'sacrifice_peasants' => 'Sacrifice %d%% of your peasants to empower your Necromancers (while active, the effects of Harmony and Plague are ignored)',
