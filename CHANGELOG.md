...
- Nomad: research point gains from invasion reduced to +25% (from +50%)
- Orc: prestige bonus removed (was +7.5%)
- Orc Bone Breaker: offense changed to 3 + 1 per 250 prestige, max 4 (from 4 + 1 per 250 prestige,  max 3)
