...
- XP per war spell changed to 8 (from 6)
...
- XP gains for info ops increased to 2 XP for espionage (from 1 XP) and 3 XP for magic (from 2 XP)
- Bounty board bonus XP now limited to the first 8 ops (from 32 ops) and each awards 8 XP (from 1-2 XP)
...
- Demon Infernal Imp: +20p (from 260p)
...
- Lizardfolk Lizardman: -10p (from 1075p)
- Lizardfolk: Erosion cost reduced to 2.5x (from 5x), amount rezoned increased to 25% (from 20%)
...
- Merfolk: Erosion cost reduced to 2.5x (from 5x), amount rezoned increased to 25% (from 20%)
...
[Unreleased]: https://github.com/OpenDominion/OpenDominion/compare/1.50.1...HEAD
